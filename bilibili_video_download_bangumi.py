...
def get_play_list(aid, cid, quality):
    ...
    headers = {
        ...
        'Cookie': 'SESSDATA=20360bb4%2C1638718206%2C0495c*61', # 登录B站后复制一下cookie中的SESSDATA字段,有效期1个月
...
if __name__ == '__main__':
    ...
    starts = input('请输入您要下载的B站番剧的完整链接地址(例如:https://www.bilibili.com/bangumi/play/ep267692，如有多个请用逗号分隔):').split(',')
    for ep_url in starts:
        headers = {
            'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36'
        }
